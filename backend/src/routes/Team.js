...
router.get("/find/:slug", authenticate, validateInput, (req, res) =>
	TeamController.findTeam(req, res)
);

router.post(
	"/submit-preferences/:slug",
	authenticate,
...
router.post("/update-scores/:teamID", validateInput, (req, res) =>
	TeamController.updateScores(req, res)
);

router.post("/shortlist/:teamID", validateInput, (req, res) =>
	TeamController.shortlist(req, res)
);

router.post("/rollback/:teamID", validateInput, (req, res) =>
	TeamController.rollback(req, res)
);
